...
export default function SurahView({ surah }: { surah: any }) {
    return (
        <div className="min-h-screen p-4 sm:p-6 lg:p-8">
            <div className="max-w-4xl mx-auto">
                <div className="fixed w-full left-0 right-0 top-16 z-10">
                    <Card className="rounded-none dark:bg-gray-800 p-4 rounded-br-2xl rounded-bl-2xl flex-row flex flex-wrap justify-between items-center max-w-4xl mx-auto border-t-0">
                        <Link href="/" prefetch>
